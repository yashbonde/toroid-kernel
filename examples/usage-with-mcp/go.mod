module example.com/slack-mcp

go 1.26.4

require github.com/yashbonde/toroid-kernel v0.3.4

replace github.com/yashbonde/toroid-kernel => ../..

require (
	charm.land/fantasy v0.31.0 // indirect
