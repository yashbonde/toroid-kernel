...
| **Cost accounting** | Built-in, gateway-truth (`x-litellm-response-cost` per llm-step) | Built-in cost/usage display | Billed via separate Agent SDK credit pool at API rates | Built-in usage tracking | Caller-managed |
